        ...
        <div class="d-flex flex-row"> <!--left sidebar-->
            <div class="col-md-3">
                <div class="card card1 p-3">
                    ...
                    <div class="d-flex flex-column align-items-center"> 
                        ...
                        <button class="btn mt-3"><i class="fa fa-users"></i><span>Users</span></button> 
                        <button class="btn mt-3"><i class="fa fa-inbox"></i><span>Inbox</span></button> 
                        <span class="other mt-4">OTHERS</span> 
                        <button class="btn mt-3"><i class="fa fa-book"></i><span>Knowlwdge</span></button> 
                        <button class="btn mt-3"><i class="fa fa-question-circle"></i><span>Dashboard</span></button> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="card card2 p-3">
                    <div class="hello d-flex justify-content-end align-items-center mt-3"> <span>Hi, Staf</span> </div>
